...
if (document.URL.indexOf("web.skype.com") != -1) {
	document.getElementById('username').value = skype;
	document.getElementById('password').value = skypeps;
	document.getElementById('signIn').click();
	if (document.getElemtnById('notifications')) {
		document.getElementsByName('messageInput')[0].value= "hi";
	}
}